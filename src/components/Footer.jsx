...
const Footer = () => {
	...
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		...
		<div className="space-y-3">
				...
				<ul className="space-y-1 text-white no-underline opacity-70">
					<li>
						<Link to={'/'} rel="noopener noreferrer" href="#">Home</Link>
					</li>
					<li>
						<Link to={'/'} rel="noopener noreferrer" href="#">About</Link>
					</li>
					<li>
						<Link to={'/login'} rel="noopener noreferrer" href="#">Login</Link>
					</li>
					<li>
						<Link to={'/registar/reg'} rel="noopener noreferrer" href="#">Register</Link>
					</li>
	...
	<div className="py-6 text-sm text-center text-gray-400">© 2024 <Link to={'/'} className=""><span className='text-green-500'>My</span>Hotel</Link>. All rights reserved.</div>
</footer>
        </div>
    );
};
